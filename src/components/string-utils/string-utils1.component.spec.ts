...
describe('Math utils Component', () => {
  ...
  it('should accurately add two Strings together', () => {
  ...
  // Spy Example
  it('should have called the StringUtilsService when StringUtils.concatenate is called', () => {
    // Create the compiled component pertinant to our test
    const fixture = TestBed.createComponent(StringUtilsComponent);
    ...
    vi.spyOn(stringUtilsService, 'concatenateTexts');
  ...
  it('should correctly assign the returned value to the addedValue variable', () => {
    ...
    vi.spyOn(stringUtilsService, 'toUppercaseText').mockReturnValue(letterToReturn);
